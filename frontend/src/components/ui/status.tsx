...
const Status = ({
  heading = "Манай системийн нөлөө",
  description = " Бидний систем нь 2025 онд 1000+ хэрэглэгчдэд хүрч, 200+ интеграциудтай хамтран ажиллаж байна. Бидний системийн нөлөө нь хэрэглэгчдийн оролцоог 250%-иар нэмэгдүүлж, жилийн 2.5 сая долларын хэмнэлт гаргаж байна.",
  link = {
    text: "Бүрэн мэдээллийг энд дарж үзнэ үү",
